...
{
    public class FirstLevelRemontViewModal: INotifyPropertyChanged
    {     
        ...
        public FirstLevelRemontViewModal()
        {
            parent_row = new Row_in_kart_defect();
            is_change = false;
        }
        public FirstLevelRemontViewModal(int id)
        {
            parent_row = new Row_in_kart_defect();
            parent_row.Par = id;
            if (id != 0)
        ...
        public FirstLevelRemontViewModal(RowDefectViewModal row)
        {
            parent_row = row.Save;           
