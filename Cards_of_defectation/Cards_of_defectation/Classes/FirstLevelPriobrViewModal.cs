...
{
    public class FirstLevelPriobrViewModal: INotifyPropertyChanged
    {      
        ...
        public FirstLevelPriobrViewModal()
        {
            parent_row = new Row_in_kart_defect();
            is_change = false;
        }
        public FirstLevelPriobrViewModal(int id)
        {
            parent_row = new Row_in_kart_defect();
            parent_row.Par = id;
            if (id != 0)
        ...
        public FirstLevelPriobrViewModal(RowDefectViewModal row)
        {
            parent_row = row.Save;
