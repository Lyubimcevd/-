...
{
    public class FirstLevelIzgotViewModal : INotifyPropertyChanged
    {        
        ...
        public FirstLevelIzgotViewModal()
        {
            parent_row = new Row_in_kart_defect();
            color = "White";
            is_change = false;
        }
        public FirstLevelIzgotViewModal(int id)
        {
            parent_row = new Row_in_kart_defect();
            parent_row.Par = id;
            if (id != 0)
        ...
        public FirstLevelIzgotViewModal(RowDefectViewModal row)
        {
            parent_row = row.Save;
